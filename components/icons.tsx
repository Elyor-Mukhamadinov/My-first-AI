...
export const MagicWandIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="m21.743 12.743-9.486-9.486a1.5 1.5 0 0 0-2.122 0L2.257 11.135a1.5 1.5 0 0 0 0 2.121l9.486 9.486a1.5 1.5 0 0 0 2.121 0L21.743 14.865a1.5 1.5 0 0 0 0-2.122Z" />
        <path strokeLinecap="round" strokeLinejoin="round" d="m14.25 11.25 4.5-4.5" />
        <path strokeLinecap="round" strokeLinejoin="round" d="m12 6 3.75-3.75M6 12l-3.75 3.75M18 18l-3.75 3.75" />
    </svg>
);
